 ...
 * @params cString é o ponteiro para char com o tamanho suficiente para receber os caracteres 
 * da string.
...
/**
  * @brief Mostrar na tela a variavel inserida pelo usuario. A função foi criada utilizando a 
  * técnica de sobreposição de argumentos da função. O sistema detecta com quantos argumentos
  * a função foi chamada e escolhe a que se encaixa.
